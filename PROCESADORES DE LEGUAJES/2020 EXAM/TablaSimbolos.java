...
public class TablaSimbolos {
   ...
   public static void putConNivF(String var,Tipo tipo) {
      if(!estaEnBloque(var)){
          tabla.get(nivel-1).put(var, tipo);
      }else{
          Generador.error(var+" Variable ya declarada");
      }
   }
   ...
   public static String declarandoConBloqueSinNivF(String var){
      
      return var+"_"+(nivel-1);
