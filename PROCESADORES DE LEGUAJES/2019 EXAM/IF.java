public class IF extends Expresion{
    ...
    public void generarCTD() {
        ...
        //Este izq.generarctd me da:
        //en caso de q izq sea condicion
        //me da : if () goto verdad
                   // goto false;
        //en caso de que izq sea and,or,not me da lo q viene en esos metodos en generarctd

        String etiqV = ((Condicion) izq).getVF().getV(); // Li
        String etiqF = ((Condicion) izq).getVF().getF(); // Lj
