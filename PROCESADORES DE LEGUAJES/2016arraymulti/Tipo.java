public class Tipo {
    ...
    public static final String ARRAYMULTIDIM="arraymultidim";
    ...
    public Tipo(String tipo,String subtipo,Integer longitud,Integer longitud2){
        this.subtipo=subtipo;
        this.tipo=tipo;
        this.longitud=longitud;
